...
@group(0) @binding(0) var<uniform> page_table_meta: PageDirectoryMeta;
...
@group(1) @binding(2) var brick_usage_buffer: texture_3d<f32>;
@group(1) @binding(3) var request_buffer: texture_3d<f32>;
