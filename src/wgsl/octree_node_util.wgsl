...
fn node_idx_get_mapped_resolutions_global(node_index: u32) -> u32 {
   return node_get_mapped_resolutions(node_idx_load_global(node_index));
}

fn node_idx_get_mapped_resolutions(node_index: u32, num_channels: u32, channel_index: u32) -> u32 {
   return node_idx_get_mapped_resolutions_global(to_multichannel_node_index(node_index, num_channels, channel_index));
}
...
fn node_idx_set_mapped_resolutions(node_index: u32, mapped_resolutions_bitmask: u32, num_channels: u32, channel_index: u32) {
    node_idx_set_mapped_resolutions_global(to_multichannel_node_index(node_index, num_channels, channel_index), mapped_resolutions_bitmask);
}
